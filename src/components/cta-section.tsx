    ...
    <section className="py-14">
      <div className="container z-10">
        <div className="mx-auto size-24 rounded-[2rem] border p-3 shadow-2xl backdrop-blur-md bg-background/10 lg:size-32">
          <Network className="mx-auto size-16 lg:size-24" />
        </div>

        <div className="z-10 mt-4 flex flex-col items-center text-center">
          <h2 className="text-3xl font-bold lg:text-4xl font-heading">
            Ready to Fix Your Network — or Build It Right the First Time?
          </h2>
          <p className="mt-2 mb-12 text-muted-foreground max-w-xl">
            Get a straight answer from a senior engineer. No sales team, no upsell, no jargon.
          </p>
